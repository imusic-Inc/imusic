...
<div onClick={() => signout ? setCreate(!create) : setSignIn(true)} className="flex-row flex-center pt-1 btn opacity-6 ">
<svg className="nav-icon" style={{width:24,height:24}} viewBox="0 0 24 24">
...
<div onClick={() => signout? setManasession("Join"):setSignIn(true)} className="flex-row flex-center pt-1 btn opacity-6 ">
<svg className="nav-icon" style={{width:24,height:24}} viewBox="0 0 24 24">
    <path fill="currentColor"
