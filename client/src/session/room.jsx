...
const [expandInvite, setExpandInvite] = useState(false);
    ...
    function setValues(value) {
        ...
        setAllowInvite(value.allowInvite ? value.allowInvite : true);
...
<LeaveCart  exit={exit} id={paths.id} udi={uid} owerId={owerId} type={type}  />
                ...
                <div className='flex-row flex-center actions' style={{display:mobile?actions?'none':'flex':null}}>
                     <div className='btn btn-back flex-row flex-center p-01' onClick={ uid !==owerId?notify:showAndHide}>
                    <svg style={{ width: '24px', height: '24px' }} viewBox="0 0 24 24">
    <path fill="currentColor" d="M20 14H14V20H10V14H4V10H10V4H14V10H20V14Z" />
</svg>
                </div>
 <div className='btn btn-back flex-row flex-center p-01' onClick={type !=='private'?showAndHideInvite:allowInvite?showAndHideInvite:uid ===owerId?showAndHideInvite:notify}>
                    <svg style={{ width: '24px', height: '24px' }} viewBox="0 0 24 24">
...
<div className='btn btn-back flex-row flex-center p-01' onClick={allowInvite && type!=='private'?showAndHideShare:notify}>
                    <svg style={{ width: '24px', height: '24px' }} viewBox="0 0 24 24">
