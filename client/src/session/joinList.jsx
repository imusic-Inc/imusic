function JoinList({ name, description, id, photo, roomType, deleteFun,joinsession }) {
    return (<div className="card">
        ...
        <div className="flex-1 p-1">
            ...
            }} className="btn bg-success button">Join</div>
            <div onClick={()=>deleteFun(id)} className="btn bg-danger button">End</div>
        </div>
    </div>);
}
