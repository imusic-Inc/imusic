...
<svg className="nav-icon" style={{width:24,height:24}} viewBox="0 0 24 24">
    ...
    <a href="https://documenter.getpostman.com/view/19413194/2s7YYvahcD" target={'_blank'} title={'API Documentation'} className="flex-row flex-center pt-1 btn opacity-6 ">
